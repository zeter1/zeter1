...
Разработал более 23 собственных программных проектов, преимущественно на Python: приложения и утилиты для Windows, инструменты автоматизации файлов и архивов, мультимедийные программы, голосовые инструменты, системную диагностику, а также средства мониторинга процессов и сети.
