...
| **[CYBER RACE](https://github.com/zeter1/CYBER-RACE)** | Web / 3D | Three.js/WebGL combat racing, modular core/game/ai/weapons/audio/ui boundaries, structural validation, headless WebGL boot smoke |
| **[Forest Hunter](https://github.com/zeter1/ForestHunter)** | Web / 3D | Three.js FPS, modular runtime boundaries, AI/progression, InstancedMesh/object pools, structural validation, headless WebGL boot smoke |
...
- **CYBER RACE:** [`src/core/`](https://github.com/zeter1/CYBER-RACE/tree/main/src/core) · [`src/game/runtime.js`](https://github.com/zeter1/CYBER-RACE/blob/main/src/game/runtime.js) · [`docs/ARCHITECTURE.md`](https://github.com/zeter1/CYBER-RACE/blob/main/docs/ARCHITECTURE.md) · [structural + browser boot CI](https://github.com/zeter1/CYBER-RACE/blob/main/.github/workflows/validate.yml).
- **Forest Hunter:** [`src/game/runtime.js`](https://github.com/zeter1/ForestHunter/blob/main/src/game/runtime.js) · [`src/ai/config.js`](https://github.com/zeter1/ForestHunter/blob/main/src/ai/config.js) · [`docs/ARCHITECTURE.md`](https://github.com/zeter1/ForestHunter/blob/main/docs/ARCHITECTURE.md) · [structural + browser boot CI](https://github.com/zeter1/ForestHunter/blob/main/.github/workflows/validate.yml).
