...
| **[CYBER RACE](https://github.com/zeter1/CYBER-RACE)** | Web / 3D | Three.js/WebGL combat racing; track/environment, opponent AI, ballistics, and HUD/minimap extracted into subsystem modules; Node contract tests + headless WebGL boot CI |
| **[Forest Hunter](https://github.com/zeter1/ForestHunter)** | Web / 3D | Three.js FPS; environment, boar AI policy, combat/reload/deployables, progression, and HUD extracted into testable modules; Node contracts + headless WebGL boot CI |
