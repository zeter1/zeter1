...
| Local-first web state | BizPilot | [`js/app.js`](https://github.com/zeter1/BizPilot/blob/main/js/app.js), [CI](https://github.com/zeter1/BizPilot/blob/main/.github/workflows/validate.yml) | browser state model, local assets, static-server contract и user-data lifecycle |
| Single-file WebGL validation | CYBER RACE | [`index.html`](https://github.com/zeter1/CYBER-RACE/blob/main/index.html), [CI](https://github.com/zeter1/CYBER-RACE/blob/main/.github/workflows/validate.yml) | inline JavaScript syntax, HTML/local-resource contract и static-server smoke |
| Single-file WebGL validation | Forest Hunter | [`index.html`](https://github.com/zeter1/ForestHunter/blob/main/index.html), [CI](https://github.com/zeter1/ForestHunter/blob/main/.github/workflows/validate.yml) | inline JavaScript syntax, HTML/local-resource contract и static-server smoke |
