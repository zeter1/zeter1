...
- **CYBER RACE / Forest Hunter** — the layer beyond modularization: deterministic gameplay math is exposed as Node-testable contracts while headless WebGL boot remains the final integration gate.
