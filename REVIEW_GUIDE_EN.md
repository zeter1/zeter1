...
- **CYBER RACE / Forest Hunter** — beyond modularization, seeded replay fixtures exercise deterministic AI/combat frame sequences while headless WebGL boot remains the final integration gate.
