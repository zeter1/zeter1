...
| Local-first web state | BizPilot | [`js/app.js`](https://github.com/zeter1/BizPilot/blob/main/js/app.js), storage and backup/restore flows | browser state model and user-data lifecycle |
